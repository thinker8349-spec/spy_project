...
# 🔥 GET ACTIVE ROOMS (WORKING METHOD)
def get_rooms():
    url = "https://api.imvu.com/chat/rooms?limit=50"
...
def scan():
    ...
    try:
        ...
        for key, room in data.get("denormalized", {}).items():
            ...
            for item in data.get("denormalized", {}).values():
